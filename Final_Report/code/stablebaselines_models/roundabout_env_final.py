...
def optimize_dqn(trial):
    ...
    best_model = DQN.load(best_model_path, env=gym.make("roundabout-v0", render_mode="human"))
...
if __name__ == "__main__":
    ...
    if TRAIN:
        ...
        model_path = r"C:\4412_labs\progress_report\logs_roundabout\best_model.zip"  # Update this path
