...
# Hyperparameters
BATCH_SIZE = 2048
GAMMA = 0.92 #0.9 for highway, 0.8 for merge
EPS_START = 0.9
EPS_END = 0.05
EPS_DECAY = 400
LEARNING_RATE = 0.00022345
NUM_EPISODES = 200
...
class DQN(nn.Module):
    def __init__(self, inputs, outputs):
        ...
        self.fc1 = nn.Linear(inputs, 512)  # Increased width
        self.fc2 = nn.Linear(512, 512)     # Additional hidden layer
        self.fc3 = nn.Linear(512, 256)     # Tapering off the width
        self.fc4 = nn.Linear(256, 256)     # Another layer for depth
        self.fc5 = nn.Linear(256, outputs) # Output layer
